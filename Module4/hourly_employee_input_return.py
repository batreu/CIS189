...
This is a copy of my previous assignment, but with modifications to return the value
"""
...
def hourly_employee_input():
    ...
    try:
        ...
        print("Please re-run the program to try again")
        return
    def weekly_pay(user_hours_input, user_pay_input):
        user_weekly_pay = (user_hours_input * user_pay_input)
        return user_weekly_pay
    return print(user_name_input + "'s weekly pay is: " + str(weekly_pay(user_hours_input, user_pay_input)))


    #print(f'{user_name_input} worked for{user_hours_input: 2.0f} hours at a rate of {user_pay_input: 4.2f} ') """we dont need this now"""
